...
- **Extensions are PXB subprocesses** (`phi.yaml` + native binary under `~/.phi/extensions` / `.phi/extensions`). Wire: `ext/pxb`. Author SDK: `ext/sdk`. Host: `internal/extension`. See [doc/extensions.md](doc/extensions.md).
