...
- **Extensions are yaegi-loaded Go under `~/.phi/extensions` / `.phi/extensions`.** Public API: `ext` package. Runtime: `internal/extension`. See [doc/extensions.md](doc/extensions.md).
